...
- 결과 디렉터리: `results/blue2/20260518T154839+0900-b1`
...
- End-to-end attack-chain validation: `inconclusive due to fallback and port-forward readiness`
...
| post-patch poc-step3 차단 여부 | `Inconclusive` |
...
B1 검증은 vulnerable baseline `controller=registry.k8s.io/ingress-nginx/controller:v1.11.3@sha256:d56f135b6462cfc476447cfe564b83a45e8bb7da2774963b00d12161112270b7`에서 patched image `controller=registry.k8s.io/ingress-nginx/controller:v1.11.5@sha256:a1cbad75b0a7098bf9325132794dddf9eef917e8a7fe246749a4cea7ff6f01eb`로 전환한 뒤 수행했다. B1 exploit-specific patch validation은 `passed`이고, end-to-end attack-chain validation은 `inconclusive due to fallback and port-forward readiness`이다. 근거: v1.11.5 blocked CVE file enumeration from 8/12 to 0/12.
